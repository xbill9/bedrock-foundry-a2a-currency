...
from coordinator.a2a_peers import ADK_PEER, FOUNDRY_PEER, get_peer, resolve_endpoint
...
def test_default_peer_is_the_adk_agent() -> None:
    assert get_peer(None) is ADK_PEER
