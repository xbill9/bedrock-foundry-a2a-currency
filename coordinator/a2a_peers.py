...
The benchmark calls two remote agents over the same A2A v1.0 wire protocol:
...
PEERS: dict[str, A2APeerProfile] = {ADK_PEER.name: ADK_PEER, FOUNDRY_PEER.name: FOUNDRY_PEER}

DEFAULT_PEER = ADK_PEER.name
